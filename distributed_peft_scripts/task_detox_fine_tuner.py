...
<Neutral>: %s"""
    example["prediction"] = prediction_format%(example["en_toxic_comment"], example["en_neutral_comment"])
    return example
...
ft.training_args.num_train_epochs=4
...
ft.train(tuning_data, "prediction", "adapters/bloom1b1-lora-toxic")